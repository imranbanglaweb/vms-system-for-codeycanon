                                    ...
                                    <div class="calls-content left visible">
                                        ...
                                        <div class="room_summary">
                                            <div class="content right">
                                                <h3 class="room_titlename">{{ $room_details->room_name}}</h3>
                                                ...
                                                <div class="rack-rate"><span class="rate-title">Amount</span><span class="rate">BDT <i> {{$room_details->amount}}</i></span></div>
