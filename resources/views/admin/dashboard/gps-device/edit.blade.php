                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="device_name" id="device_name" class="form-control" 
                                                   value="{{ $gpsDevice->device_name }}" required>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="device_type" id="device_type" class="form-control select2">
                                                ...
                                                @foreach($deviceTypes as $key => $value)
                                                    <option value="{{ $key }}" {{ $gpsDevice->device_type == $key ? 'selected' : '' }}>
                                                        {{ $value }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="imei_number" id="imei_number" class="form-control" 
                                                   value="{{ $gpsDevice->imei_number }}" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="protocol" id="protocol" class="form-control select2" required>
                                            ...
                                            @foreach($protocols as $key => $value)
                                                <option value="{{ $key }}" {{ $gpsDevice->protocol == $key ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="vehicle_id" id="vehicle_id" class="form-control select2">
                                            ...
                                            @foreach($vehicles as $vehicle)
                                                <option value="{{ $vehicle->id }}" {{ $gpsDevice->vehicle_id == $vehicle->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" name="installation_date" id="installation_date" class="form-control" 
                                                   value="{{ $gpsDevice->installation_date }}">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="notes" id="notes" class="form-control" rows="3">{{ $gpsDevice->notes }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    $('#gpsDeviceForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    Swal.fire({ icon: 'success', title: 'Success!', text: response.message || 'GPS Device updated successfully!', confirmButtonColor: '#4a90e2' })
                    .then((result) => {
