...
<section role="main" class="content-body">
    <header class="page-header">
        <h2><i class="fa fa-calendar-alt mr-2"></i>Monthly Fuel Summary</h2>
        <div class="right-wrapper">
            <ol class="breadcrumbs">
                <li><a href="{{ route('home') }}"><i class="fa fa-home"></i></a></li>
                <li><span>Fuel Management</span></li>
                <li><span>Monthly Summary</span></li>
            </ol>
        </div>
    </header>
            ...
            <div class="col-md-12">
                <div class="table-card">
                    <div class="card-header">
                        <h3 class="card-title mb-0"><i class="fa fa-chart-bar mr-2"></i>Monthly Fuel Consumption</h3>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $data->total_liters > 0 ? number_format($data->total_cost / $data->total_liters, 2) : 0 }}</td>
                                </tr>
                                @empty
