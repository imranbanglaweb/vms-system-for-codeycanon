...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0 fw-bold">
            <i class="fa-solid fa-truck-moving me-2"></i> Maintenance Transport Approval
        </h3>
    </div>
    ...
    <div class="card shadow-sm border-0 mb-3">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="maintenanceTransportApprovalTable" class="table table-bordered table-hover align-middle w-100">
...
$(function(){
    ...
    var table = $('#maintenanceTransportApprovalTable').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        autoWidth: false,
        ...
        ajax: {
            url: "{{ route('maintenance_transport_approvals.ajax') }}",
            data: function(d) {
