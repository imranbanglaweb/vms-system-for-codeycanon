<a href="{{ route('maintenance_transport_approvals.show', $r->id) }}" class="btn btn-info btn-sm" title="View Details">
    <i class="fa fa-eye"></i>
</a>
@if(in_array($r->transport_status, ['Pending', null]) && $r->department_status == 'Approved')
