...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3 mt-2">
        <h3 class="fw-bold text-primary mb-0"><i class="bi bi-car-front-fill me-2"></i>Add New Vehicle</h3>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <form id="vehicle_create_form" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="vehicle_name" name="vehicle_name" value="{{ old('vehicle_name') }}" placeholder="Enter vehicle name">
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="license_plate" name="license_plate" value="{{ old('license_plate') }}" placeholder="Enter license plate">
                        </div>
                ...
                <div class="row g-3 mt-2">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="seat_capacity" name="seat_capacity" value="{{ old('seat_capacity') }}" placeholder="Enter seat capacity" min="1">
                        </div>
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="alert_cell_number" name="alert_cell_number" value="{{ old('alert_cell_number') }}" placeholder="Enter alert number">
                        </div>
                ...
                <div class="row mt-4">
                    <div class="col-12 text-end">
                        ...
                        <button type="submit" class="btn btn-success" id="submit_btn">
                            <span id="btn_text"><i class="bi bi-check-circle"></i> Create Vehicle</span>
                        </button>
                    </div>
                </div>
            </form>
...
$(document).ready(function() {
    ...
    $('#vehicle_create_form input, #vehicle_create_form select').on('input change', function() {
    ...
    $('#vehicle_create_form').on('submit', function(e) {
        e.preventDefault();
