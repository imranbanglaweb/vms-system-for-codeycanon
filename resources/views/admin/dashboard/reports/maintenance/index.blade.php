            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0 small">Track vehicle maintenance records</p>
                    </div>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{ route('reports.maintenance.excel') }}">
                                <i class="fas fa-file-excel text-success me-2"></i> Excel
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('reports.maintenance.pdf') }}">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h4 class="mb-0 fw-bold">{{ $records->total() ?? 0 }}</h4>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h4 class="mb-0 fw-bold">{{ $records->where('status', 'pending')->count() ?? 0 }}</h4>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h4 class="mb-0 fw-bold">{{ $records->where('status', 'in_progress')->count() ?? 0 }}</h4>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h4 class="mb-0 fw-bold">{{ $records->where('status', 'completed')->count() ?? 0 }}</h4>
                            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        <h6 class="mb-0 fw-bold">
                            <i class="fas fa-table text-primary me-2"></i>Maintenance Data
                        </h6>
                        <span class="badge bg-secondary">{{ $records->total() ?? 0 }} Records</span>
                    </div>
...
$(function() {
    function fetchData(page) {
        ...
        $.ajax({
            url: "{{ route('reports.maintenance.ajax') }}",
            type: "GET",
