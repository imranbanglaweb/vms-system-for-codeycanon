...
{!! Form::model($company, ['method'=>'PATCH','enctype'=>'multipart/form-data', 'id'=>'company_edit']) !!}
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="form-group">
           ...
           <select class="form-control select2" name="unit_id">
             ...
             <option value="{{ $unit->id}}" {{ $company->unit_id == $unit->id ? 'selected' : '' }}>{{ $unit->unit_name}}</option>
             @endforeach
           </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
           ...
           <select name="status" class="form-control">
               ...
               <option value="suspended" {{ $company->status == 'suspended' ? 'selected' : '' }}>In Active</option>
           </select>
        </div>
    </div>
...
$('#company_edit').submit(function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
            Swal.fire({
                html: '<span style="color:green">Company Updated Successfully</span>',
                icon: 'success',
                type: 'success',
                title: 'Success!',
                focusConfirm: false,
