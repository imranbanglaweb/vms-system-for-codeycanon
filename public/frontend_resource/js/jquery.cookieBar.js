...
(function ( $ ) {
	...
	translation['en'] = {
		message:     'This site uses cookies to enhance the user experience. These cookies do not collect personal information.<br/>If you agree to our use of cookies, please continue to browse our site.',
		infoText:    '&nbsp;&nbsp;Click here to find out more.',
		acceptText:  'Accept',
	...
	var methods	= {
		init : function(options) {
			...
			var defaults = {
				infoLink:       'https://www.grandsultanresort.com/guest-policy',
				infoTarget:     '_blank',
				wrapper:        'body',
				expireDays:     365,
				style:          'bottom',
		...
		displayBar : function() {
			...
			var template = '<div id="cookie-bar" class="cookie-bar cookie-bar--' + config.style + '"><div class="cookie-bar__inner"><span class="cookie-bar__message">' + translation[config.language].message + infoLink + '</span><span class="cookie-bar__buttons">' + acceptButton + privacyButton + '</span></div></div>';
