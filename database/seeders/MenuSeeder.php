...
class MenuSeeder extends Seeder
{
    public function run()
    {
        ...
        $childMenus = [
            ...
            [
                'menu_name' => 'Driver Schedule',
                'menu_slug' => 'driver-schedule',
                'menu_icon' => 'fa-calendar',
                'menu_url' => 'driver-schedule.index',
                'menu_permission' => 'driver-schedule-manage',
                'menu_order' => 4,
                'parent_name' => 'Driver Management',
            ],
            [
                ...
                'menu_url' => 'driver-availability.index',
                'menu_permission' => 'driver-availability-manage',
                'menu_order' => 5,
                'parent_name' => 'Driver Management',
            ],
            [
                ...
                'menu_url' => 'driver-performance.index',
                'menu_permission' => 'driver-performance-manage',
                'menu_order' => 6,
                'parent_name' => 'Driver Management',
            ],
            [
